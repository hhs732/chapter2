...
paramfile = Dataset("summa_zParamTrial_scT1_veg3.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
#%% 
varcheck = Dataset ('summa_zParamTrial_scT1_veg1.nc')
