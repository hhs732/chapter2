...
p1 = [273.16,273.66] #,273.5,273.66 tempCritRain	
p2 = [1,1.045] # 1.045 frozenPrecipMultip	

p3 = [2,3,4] #2, 3, 4] #mw_exp exponent for meltwater flow
p4 = [0.28,0.4] #windReductionParam        |       0.2800 |       0.0000 |       1.0000
p5 = [0.001,0.002] #zsnow

p6 = [0.85,0.9] #0.89 albedoMaxVisible |       0.9500 |       0.7000 |       0.9500
p7 = [0.6,0.7] #albedoMaxNearIR 0.83|       0.6500 |       0.5000 |       0.7500
p8 = [3,5]#,1] #albedoRefresh |       1.0000 |       1.0000 |      10.0000
p9 = [150000,250000,420000,600000]#,350000,200000] ##albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 

p10 = [0.3] #0.5albedoSootLoad
p11 = [0.7] #0.75 albedoMinVisible 0.76|       0.7500 |       0.5000 |       0.7500
p12 = [0.3] #albedoMinNearIR  0.49|       0.3000 |       0.1500 |       0.4500
p13 = [0.86] #0.89albedoMax |       0.8500 |       0.7000 |       0.9500
...
param_nam_list = ['tempCritRain','frozenPrecipMultip','mw_exp','windReductionParam','z0Snow',
                  'albedoMaxVisible','albedoMaxNearIR','albedoRefresh','albedoDecayRate',
                  'albedoSootLoad','albedoMinVisible','albedoMinNearIR','albedoMax',
