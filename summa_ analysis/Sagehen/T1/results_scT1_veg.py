...
from resultsScT1NcFiles import scT1NcFilesVeg2
from resultsScT1NcFiles import scT1NcFilesVeg3
from resultsScT1NcFiles import scT1NcFilesVeg4
...
av_swe_dfVeg1 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg1,'scalarSWE',hru_names_dfVeg1,Date)
av_swe_dfVeg2 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg2,'scalarSWE',hru_names_dfVeg2,Date)
av_swe_dfVeg3 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg3,'scalarSWE',hru_names_dfVeg3,Date)
av_swe_dfVeg4 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg4,'scalarSWE',hru_names_dfVeg4,Date)
...
#
plt.title('SWE (mm); SagehenT1_veg4', position=(0.04, 0.88), ha='left', fontsize=30)
plt.xlabel('Time 2015-2017', fontsize=30)
plt.ylabel('SWE(mm)', fontsize=30)
#plt.legend()
#plt.show()
plt.savefig('swe_ScT1_veg4.png')
...
dosd_residual_Veg1_df = calculateResidualDOSD('2016','2017',4656,14424,dosd_veg1_df,hru_names_dfVeg1)
dosd_residual_Veg1_df_earlier = dosd_residual_Veg1_df[dosd_residual_Veg1_df['dosdSY'] > 0].dropna()
hru_Veg1_dosdEarlier = dosd_residual_Veg1_df_earlier.index.tolist()

dosd_residual_Veg2_df = calculateResidualDOSD('2016','2017',4656,14424,dosd_veg2_df,hru_names_dfVeg2)
...
dosd_residual_Veg3_df = calculateResidualDOSD('2016','2017',4656,14424,dosd_veg3_df,hru_names_dfVeg3)
dosd_residual_Veg3_df_earlier = dosd_residual_Veg3_df[dosd_residual_Veg3_df['dosdSY'] > 0].dropna()
hru_Veg3_dosdEarlier = dosd_residual_Veg3_df_earlier.index.tolist()

dosd_residual_Veg4_df = calculateResidualDOSD('2016','2017',4656,14424,dosd_veg4_df,hru_names_dfVeg4)
...
#plt.legend()
#plt.show()
plt.savefig('swe_ScT1_veg4_earlier.png')
#%% scalarLWNetGround
av_nlwrG_df_vg1 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg1,'scalarLWNetGround',hru_names_dfVeg1,Date)
av_nlwrG_df_vg2 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg2,'scalarLWNetGround',hru_names_dfVeg2,Date)
av_nlwrG_df_vg3 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg3,'scalarLWNetGround',hru_names_dfVeg3,Date)
av_nlwrG_df_vg4 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg4,'scalarLWNetGround',hru_names_dfVeg4,Date)
...
av_nswrG_df_vg1 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg1,'scalarGroundAbsorbedSolar',hru_names_dfVeg1,Date)
av_nswrG_df_vg2 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg2,'scalarGroundAbsorbedSolar',hru_names_dfVeg2,Date)
av_nswrG_df_vg3 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg3,'scalarGroundAbsorbedSolar',hru_names_dfVeg3,Date)
av_nswrG_df_vg4 = readNcfdatasetF0rEachVariableT0dataframe(scT1NcFilesVeg4,'scalarGroundAbsorbedSolar',hru_names_dfVeg4,Date)
...
plt.savefig('dosd_Veg_T1_earlier.png')
...
plt.savefig('NLWR_Veg_T1_earlier.png')
...
bp2['boxes'][5].set(color='palevioletred', linewidth=2, facecolor = 'pink', hatch = '/')
bp2['boxes'][6].set(color='pink', linewidth=2, facecolor = 'pink', hatch = '/')
bp2['boxes'][7].set(color='firebrick', linewidth=2, facecolor = 'pink', hatch = '/')
...
plt.savefig('NSWR_Veg_T1_earlier.png')
