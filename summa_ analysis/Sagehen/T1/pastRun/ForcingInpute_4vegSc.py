...
print scT4fd.variables['latitude'][:]
print scT4fd.variables['longitude'][:]

print scT1fd_in.variables['latitude'][:]
print scT1fd_in.variables['longitude'][:]
#%% sagehen timming
...
#%% define hru id, time step (1hr), lat and lon; (T4 lat: 39.42222°  lon: -120.2989°)
step = np.array([3600])

lat_sa = np.array([39.42222])
