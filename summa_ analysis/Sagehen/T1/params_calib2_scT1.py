...
p4 = [1,1.045] # 1.045 frozenPrecipMultip
p5 = [0.28,0.4] #windReductionParam        |       0.2800 |       0.0000 |       1.0000
p6 = [0.001,0.002] #zsnow

p7 = [0.85,0.9] #0.89 albedoMaxVisible |       0.9500 |       0.7000 |       0.9500
p8 = [0.6,0.7] #albedoMaxNearIR 0.83|       0.6500 |       0.5000 |       0.7500
p9 = [0.6,0.7,0.75] #0.75 albedoMinVisible 0.76|       0.7500 |       0.5000 |       0.7500
p10 = [0.3,0.45] #albedoMinNearIR  0.49|       0.3000 |       0.1500 |       0.4500
p11 = [600000,800000] ##albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 
p12 = [0.3,0.5] #0.5albedoSootLoad
...
hruidxID = hru_ix_ID(p4, p5, p6, p7, p8, p9, p10, p11, p12, )#, p10, p11, p12, p13, p14, p15, p16, p17 p18, p19, p20, p21
#
...
param_nam_list = ['tempCritRain','mw_exp','albedoRefresh',
                  'frozenPrecipMultip','windReductionParam','z0Snow',
