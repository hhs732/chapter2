...
p3 = [0.28] #windReductionParam        |       0.2800 |       0.0000 |       1.0000
p4 = [0.002] #zsnow

p5 = [0.85] #0.89 albedoMaxVisible |       0.9500 |       0.7000 |       0.9500
p6 = [0.7] #0.75 albedoMinVisible 0.76|       0.7500 |       0.5000 |       0.7500
p7 = [0.6] #albedoMaxNearIR 0.83|       0.6500 |       0.5000 |       0.7500
p8 = [0.3] #albedoMinNearIR  0.49|       0.3000 |       0.1500 |       0.4500
p9 = [5]#,1] #albedoRefresh |       1.0000 |       1.0000 |      10.0000
p10 = [420000]#,350000,200000] ##albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 
...
def param_fill(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19): 
    b = list(itertools.product(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19))
    ...
    for tup in b:
        ...
        p15l.append(tup[14]); p16l.append(tup[15]); p17l.append(tup[16]); p18l.append(tup[17]); p19l.append(tup[18])
    return(p1l, p2l, p3l, p4l, p5l, p6l, p7l, p8l, p9l, p10l, p11l, p12l, p13l, p14l, p15l, p16l, p17l, p18l, p19l)  

# call the function on the parameters
valst1 = param_fill(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19) 
...
paramfile = Dataset("summa_zParamTrial_scT4_open_calib.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file

hru = paramfile.createDimension('hru', None)
hidx = paramfile.createVariable('hruIndex', np.float64,('hru',)) # add hruIndex variable

param_nam_list = ['tempCritRain','mw_exp','windReductionParam','z0Snow',
                  'albedoMaxVisible','albedoMinVisible','albedoMaxNearIR','albedoMinNearIR','albedoRefresh','albedoDecayRate',
                  'albedoSootLoad','albedoMax','winterSAI','summerLAI','LAIMIN','LAIMAX','heightCanopyTop','heightCanopyBottom','z0Canopy'
                  ] 
for param in param_nam_list:
    paramfile.createVariable(param, np.float64,('hru',))

constant_params = ['rootingDepth','rootDistExp','theta_sat','theta_res','vGn_alpha','vGn_n','k_soil','critSoilWilting','critSoilTranspire','frozenPrecipMultip']
...
#%% 
varcheck = Dataset ('summa_zParamTrial_scT4_open_calib.nc')
...
in_condi = Dataset("summa_zInitialCond_scT4_open.nc",'w',format='NETCDF3_CLASSIC')
...
in_condi.close()
#%%
iccheck = Dataset("summa_zInitialCond_scT4_open.nc")
