...
# changing veg params
#p8 = [0.4] #albedoMinWinter
#lslj_rsu1 111111122.0
#lslj_rsu1 111111122.0
p9 = [0.7,0.75] #0.84,0.8albedoMax |       0.8500 |       0.7000 |       0.9500
p10 = [0.3] #,0.4albedoMinSpring
p11 = [100000] #,420000,300000albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 
p12 = [0.7] #0.85,0.75albedoMaxVisible |       0.9500 |       0.7000 |       0.9500
p13 = [0.5] #,0.7,0.6, albedoMinVisible 0.76|       0.7500 |       0.5000 |       0.7500
p14 = [0.5] #,0.6albedoMaxNearIR 0.83|       0.6500 |       0.5000 |       0.7500
p15 = [0.15] #,0.3albedoMinNearIR  0.49|       0.3000 |       0.1500 |       0.4500
p16 = [8,9]#,1] #5,albedoRefresh |       1.0000 |       1.0000 |      10.0000
p17 = [0.5] #0.3albedoSootLoad |       0.3000 |       0.1000 |       0.5000

p18 = [1100,1300] #specificHeatVeg
p19 = [0.1] #ratioDrip2Unloading       |       0.4000 |       0.0000 |       1.0000

p20 = [13] #refInterceptCapSnow       |       6.6000 |       1.0000 |      10.0000 #refInterceptCapSnow   =  reference canopy interception capacity per unit leaf area (snow) (kg m-2)
p21 = [0.5] #refInterceptCapRain
p22 = [0] #snowUnloadingCoeff        |       0.0000 |       0.0000 |       1.5d-6
p23 = [3] #rootingDepth
...
hruidxID = hru_ix_ID(p9, p16, p18)#p10, p11, p12, p13, p14, p15, 
#
...
#'tempCritRain','mw_exp','z0Snow','z0Canopy','newSnowDenMin','leafDimension','throughfallScaleSnow','leafExchangeCoeff','windReductionParam'
#
...
print varcheck.variables['snowUnloadingCoeff'][:]
