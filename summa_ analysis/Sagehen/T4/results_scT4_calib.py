...
out_names = ['llj','llt','slt','lsj','slj','lst','sst']#,'ssj'
...
av_ncfiles = ["C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_llj_2015-2016_senatorVariableDecayRate_1.nc",
              ...
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_llt_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_llt_2016-2017_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_slt_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_slt_2016-2017_senatorVariableDecayRate_1.nc",  
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_lsj_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_lsj_2016-2017_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_slj_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_slj_2016-2017_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_lst_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_lst_2016-2017_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_sst_2015-2016_senatorVariableDecayRate_1.nc",
              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_sst_2016-2017_senatorVariableDecayRate_1.nc",
#              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_ssj_2015-2016_senatorVariableDecayRate_1.nc",
#              "C:\Users\HHS\summaTestCases_2.x\output\sagehencreek\scT4_openCal_ssj_2016-2017_senatorVariableDecayRate_1.nc"
                ]
...
#for hru in hru_names_df0[0][29161:34992]:
...
maxSweFY_1obs = maxSwe1.copy() #[1147.13] # 14/3/2016 8am
maxSweFY_1 = readSpecificDatafromAllHRUs(av_swe_df,hru_names_df0[0],3968)
maxSweFY_2obs = 1143.2 #31/3/2016 8am
maxSweFY_2 = readSpecificDatafromAllHRUs(av_swe_df,hru_names_df0[0],4376)

maxSweSY_1obs = 1770.62 #6/3/2017 14pm
maxSweSY_1 = readSpecificDatafromAllHRUs(av_swe_df,hru_names_df0[0],12542)
maxSweSY_2obs = maxSwe2.copy() # [1901.34] # 21/4/2017 6am
maxSweSY_2 = readSpecificDatafromAllHRUs(av_swe_df,hru_names_df0[0],13638)

maxSwe_obs_df = pd.DataFrame(np.array([maxSweFY_1obs,maxSweFY_2obs,maxSweSY_1obs,maxSweSY_2obs])).T; maxSwe_obs_df.columns=['maxFY_1','maxFY_2','maxSY_1','maxSY_2']
maxSwe_df = pd.DataFrame(np.array([maxSweFY_1,maxSweFY_2,maxSweSY_1,maxSweSY_2])).T; maxSwe_df.columns=['maxFY_1','maxFY_2','maxSY_1','maxSY_2']

maxSwe_residual=[]
for crit in maxSwe_df.columns:
    maxSwe_residual.append(abs(maxSwe_obs_df[crit][0]-maxSwe_df[crit]))

maxSwe_residual_df = pd.DataFrame(np.reshape(np.array(maxSwe_residual),(4,len(maxSwe_df))).T, columns=['maxSweFY_1','maxSweFY_2','maxSweSY_1','maxSweSY_2'])

#%% find best params
criteria_df = pd.concat([maxSwe_residual_df, dosd_residual_df], axis=1) 
criteria_df.set_index(hru_names_df0[0],inplace=True)
pareto_model_param = pd.DataFrame(criteria_df.index[((criteria_df['dosd2016'])<=3) & ((criteria_df['dosd2017'])<=2) &
                                                    ((criteria_df['maxSweFY_1']) <= 48) & ((criteria_df['maxSweFY_2'])<=40) & 
                                                    ((criteria_df['maxSweSY_1'])<=34) & ((criteria_df['maxSweSY_2'])<=49)].tolist()) #
# 3  2  48  40  34  49                                                   
#%%
...
plt.title('SWE (mm) SCT4', position=(0.04, 0.88), ha='left', fontsize=40)
plt.xlabel('Time 2015-2017', fontsize=30)
plt.ylabel('SWE(mm)', fontsize=30)
#plt.legend()
plt.savefig('sweScT4_calib1.png')
