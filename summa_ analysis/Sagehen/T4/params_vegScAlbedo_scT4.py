...
p8 = [2,4] # 4 mw_exp exponent for meltwater flow

p9 = [0.7,0.84] #0.86 albedoMax |       0.8500 |       0.7000 |       0.9500
p10 = [0.4,0.6] #albedoMinWinter     0.6000 |       0.6000 |       1.0000
p11 = [0.3,0.45] #albedoMinSpring    0.4500 |       0.3000 |       1.0000
p12 = [100000,1000000] #420000 albedoDecayRate |       1.0d+6 |       0.1d+6 |       5.0d+6 
p13 = [0.7,0.78] #0.85 albedoMaxVisible |       0.9500 |       0.7000 |       0.9500
p14 = [0.5,0.6] #0.7 albedoMinVisible 0.76|       0.7500 |       0.5000 |       0.7500
p15 = [0.5,0.6] # 0.6 albedoMaxNearIR 0.83|       0.6500 |       0.5000 |       0.7500
p16 = [0.15,0.27] # 0.3 albedoMinNearIR  0.49|       0.3000 |       0.1500 |       0.4500
p17 = [1,5] # 5 albedoRefresh |       1.0000 |       1.0000 |      10.0000
p18 = [0.1,0.4] # 0.3 albedoSootLoad |       0.3000 |       0.1000 |       0.5000

p19 = [10] #[6,13]refInterceptCapSnow       |       6.6000 |       1.0000 |      10.0000 #refInterceptCapSnow   =  reference canopy interception capacity per unit leaf area (snow) (kg m-2)

p20 = [0.3] # [0.3,0.7]0.5 throughfallScaleSnow [0.3,0.45,0.6]
p21 = [0.4] #[0.4,0.8]throughfallScaleRain      |       0.6000 |       0.1000 |       0.9000

p22 = [0.3] #[0.1,0.6]ratioDrip2Unloading       |       0.4000 |       0.0000 |       1.0000
...
hruidxID = np.arange(100001,102049)
#
hru_num = np.size(hruidxID)

paramfile = Dataset("summa_zParamTrial_scT4_veg1_albedo.nc",'w',format='NETCDF3_CLASSIC') #create new paramtrail.nc file
...
#%%
varcheck = Dataset ("summa_zParamTrial_scT4_veg4_albedo.nc")
