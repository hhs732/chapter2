...
with open("hhs_jemez_vcm.csv") as scvd:
...
scT1_ppt_hr = scT1_ppt.resample('H').mean()
...
#%% make new nc file 
new_fc_sc = Dataset("forcing_JmzVcm_open_calib.nc",'w',format='NETCDF3_CLASSIC')
# define dimensions 
...
new_fc_sc.close()
#%%
testfd = Dataset("forcing_JmzVcm_open_calib.nc")
