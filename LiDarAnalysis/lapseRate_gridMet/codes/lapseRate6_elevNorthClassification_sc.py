...
meanTemp_elevClass_sc17a = calculationMeanTempforEachElevClassification(veg_snow_temp_sc_clsf17a)   
...
# the line equation:
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/tempLsr_nrth_sc.png')
