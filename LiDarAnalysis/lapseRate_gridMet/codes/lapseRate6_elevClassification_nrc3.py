...
numGrids_nrc = number0fGridsInEachElevationBand(veg_snow_temp_clsfnrc)
...
# the line equation:
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/tempLsr_nrc2.png')
