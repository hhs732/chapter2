...
ascii_index_pr17a = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/ascii_index_pr_sc17A.npy')
#calculating topo_dimension from cut northness

ascii_grid_veg_index17a = classificationGridCells(ascii_index_pr17a,gridCells_m)
# slope less than 30
...
ascii_index_pr24m = np.load('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/ascii_index_pr_sc24May.npy')
#calculating topo_dimension from cut northness

ascii_grid_veg_index24m = classificationGridCells(ascii_index_pr24m,gridCells_m)
# slope less than 30
...
# the line equation:
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/tempLsr_sc.png')
