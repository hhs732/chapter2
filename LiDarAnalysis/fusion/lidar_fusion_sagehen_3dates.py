...
rects1 = plt.bar(index, d11, bar_width, color='beige', edgecolor='silver', label='0pen') #  snow  ghostwhite
...
plt.savefig('G:/hhs_DST/lidar_analysis/sagehen/fusion/fSCA_pixel_sagehen_elev_topo10_noG30May18.png')
