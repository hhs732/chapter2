...
extent2 = [355000,361000,3970000,3976000]

filenameIn = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffJemez.tif"
pathNameOut = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffJemez.png"
...
elevNrth_gp, index_df = calculatingSlopeAspectNorthness(filenameIn,elevationMissNoS0f,
                                                        'G:/hhs_DST/lidar_analysis/fusion/slopeJem.tif',
                                                        'G:/hhs_DST/lidar_analysis/fusion/aspectJem.tif')
...
veg_count_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_count.asc"
veg_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_count.png"
...
veg_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_totalCount.asc"
veg_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_totalCount.png"
...
veg_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_allCoverCount.asc"
veg_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_veg_allCoverCount.png"
...
veg_density_jm = veg_allCoverCount_df_cut['z']/veg_totalCount_df_cut['z']
veg_density_jm_ls = np.vstack([veg_allCoverCount_df_cut['x'],veg_allCoverCount_df_cut['y'],veg_density_jm]).T
np.save('G:/hhs_DST/lidar_analysis/fusion/veg_density_jm', veg_density_jm_ls)
#%% ascii files snow 0n 23May2016
#loading snow ascii file (count)
snow_count_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_count.asc"
snow_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_count.png"
...
snow_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_totalCount.asc"
snow_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_totalCount.png"
...
snow_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_allCoverCount.asc"
snow_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/jemez_allcount/jemez_snw_allCoverCount.png"
...
np.save('G:/hhs_DST/lidar_analysis/fusion/ascii_index_pr_jmz', ascii_index_pr)

#calculating topo_dimension from cut northness
properties = [-0.1,0.1,2800,3130] #2481  3433
...
rects1 = plt.bar(index, d11, bar_width, color='ghostwhite', edgecolor='brown', label='0pen') #  snow  beige

rects2 = plt.bar(index + bar_width, d22, bar_width, color='olivedrab',edgecolor='darkgreen',label='underTree')#mediumseagreen   green  olivedrab  
...
plt.title('fSCA% in JRBN in April 2010', fontsize=40)
plt.legend(fontsize=30, loc = 'upper left')
plt.savefig('G:/hhs_DST/lidar_analysis/fusion/fSCA_pixel_jemez_elev_topo10_noG30.png')
