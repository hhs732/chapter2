...
#%% dem snow off (veg) 
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_veg_totalCount.asc"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/demSnw0ffKrew.tif"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_snw_allCoverCount.asc"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_snw_count.asc"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_snw_totalCount.asc"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_veg_allCoverCount.asc"
"C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/fusion/krew_doublecheck_extent/krew_veg_count.asc"
elevationMissNoS0f = 2000.
#G:/hhs_DST/lidar_analysis/fusion/
extent2 = [303500,306000,4100400,4106000]

filenameIn = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffKrew.tif"
pathNameOut = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffKrew.png"
...
elevNrth_gp, index_df = calculatingSlopeAspectNorthness(filenameIn,-1.4,
                                                        'G:/hhs_DST/lidar_analysis/fusion/slopekrw.tif',
                                                        'G:/hhs_DST/lidar_analysis/fusion/aspectkrw.tif')
...
veg_count_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_count.asc"
veg_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_count.png"
...
veg_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_totalCount.asc"
veg_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_totalCount.png"
...
veg_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_allCoverCount.asc"
veg_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_veg_allCoverCount.png"
...
veg_density_kr = veg_allCoverCount_df_cut['z']/veg_totalCount_df_cut['z']
veg_density_kr_ls = np.vstack([veg_allCoverCount_df_cut['x'],veg_allCoverCount_df_cut['y'],veg_density_kr]).T
np.save('G:/hhs_DST/lidar_analysis/fusion/veg_density_kr', veg_density_kr_ls)
#%% ascii files snow 0n 23May2016
#loading snow ascii file (count)
snow_count_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_count.asc"
snow_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_count.png"
...
snow_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_totalCount.asc"
snow_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_totalCount.png"
...
snow_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_allCoverCount.asc"
snow_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/krew_allcount/krew_snw_allCoverCount.png"
...
np.save('G:/hhs_DST/lidar_analysis/fusion/ascii_index_pr_krew', ascii_index_pr)

#calculating topo_dimension from cut northness
properties = [-0.1,0.1,1600,1850] #1367  2109
...
rects1 = plt.bar(index, d11, bar_width, color='beige', edgecolor='brown', label='0pen') #  snow  ghostwhite

rects2 = plt.bar(index + bar_width, d22, bar_width, color='mediumseagreen',label='underTree')#   green  olivedrab edgecolor='darkgreen', 
...
plt.title('fSCA% in KREW in March 2010', fontsize=40)
plt.legend(fontsize=30, loc = 'upper left')

plt.savefig('G:/hhs_DST/lidar_analysis/fusion/fSCA_pixel_krew_elev_topo10_noG30.png')
#%%
...
justify_pathon = "G:/hhs_DST/lidar_analysis/fusion/lasFiles/justif_snwon_krew2.las"
justify_pathof = "G:/hhs_DST/lidar_analysis/fusion/lasFiles/justif_snwof_krew2.las"

justify_coord_son = readLasFile (justify_pathon)
justify_coord_sof = readLasFile (justify_pathof)
avrg_sonZ = np.mean(justify_coord_son['z'])
avrg_sofZ = np.mean(justify_coord_sof['z'])
