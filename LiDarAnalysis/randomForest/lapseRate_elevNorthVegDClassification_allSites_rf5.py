...
importance_bins_krew = np.array([feature_importances_error_0putBin[0][0].values[0],
                            feature_importances_error_0putBin[1][0].values[0],
...
savePath_krew = 'C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/randomForest/Krew/importance_tempD2M_0put_krew_bin_bar4.png'
plotrandomForestimportancesfor4bins(feature_importances_error_0putBin,importance_bins_krew,color_krew,'KREW',savePath_krew)
...
[feature_importances_0p_ut_mean,mean_abs_error_oput] = randomForestModel4FscaUnderTree0r40p_ut(in_ut_0p_rf_krew,out_ut_0p_rf_krew,59,200)

pathName_0p_ut = 'C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/randomForest/Krew/importance_0p_ut_krew_lswr (error='
plot_rfm_importance (mean_abs_error_oput, feature_importances_0p_ut_mean, pathName_0p_ut, 'indianred', 'fSCAop-fSCAut')
...
out_ut_0p_rf_jmz = pd.DataFrame(in_out_rf_jmz_lswr_ls_drp_df['fsca_ut']-in_out_rf_jmz_lswr_ls_drp_df['fsca_0p'], columns = ['fSCA_op_M_fSCA_ut']).iloc[:,0]
[feature_importances_0p_ut_mean2,mean_abs_error_oput2] = randomForestModel4FscaUnderTree0r40p_ut(in_ut_0p_rf_jmz,out_ut_0p_rf_jmz,59,200)
...
plot_rfm_importance (mean_abs_error_oput2, feature_importances_0p_ut_mean2, pathName_0p_ut, 'mediumseagreen', 'fSCAop-fSCAut for JMZ')
...
sens_vegSwr_jmz_up = randomForest_sensMod_predict(in_ut_0p_rf_jmz,out_ut_0p_rf_jmz,59,200,in_ut_0p_rf_jmz_vegSen_up)
...
sens_vegSwr_jmz_low = randomForest_sensMod_predict(in_ut_0p_rf_jmz,out_ut_0p_rf_jmz,59,200,in_ut_0p_rf_jmz_vegSen_low)

savePath1_jmz = 'C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/randomForest/jmz/deltaFsca_predicted_jmz.png'
savePath2_jmz = 'C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/randomForest/jmz/deltaFsca_predicted_scatter_jmz.png'
plotSensitivitySWRvegDensity(sens_vegSwr_jmz_up,sens_vegSwr_jmz_low,savePath1_jmz,savePath2_jmz,'yellowgreen','darkolivegreen','JMZ','viridis_r')
