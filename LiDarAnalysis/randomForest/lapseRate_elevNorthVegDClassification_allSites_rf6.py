...
numPix_m95Veg = len(in_ut_0p_rf_krew[in_ut_0p_rf_krew['VegD']>0.95])
...
sens_vegSwr_krew_up = randomForest_sensMod_predict(in_ut_0p_rf_krew,out_ut_0p_rf_krew,59,200,in_ut_0p_rf_krew_vegSen_up[11:90])
...
sens_vegSwr_krew_low = randomForest_sensMod_predict(in_ut_0p_rf_krew,out_ut_0p_rf_krew,59,200,in_ut_0p_rf_krew_vegSen_low[11:90])

savePath1_krew = 'C:/1UNRuniversityFolder/Dissertation/documents/myPapers/paper1_SDD/deltaFsca_predicted_krew2.png'
...
print (len(in_ut_0p_rf_sc26m[in_ut_0p_rf_sc26m['VegD']>0.90]))
...
in_ut_0p_rf_sc26m_vegSen_up = pd.DataFrame(np.reshape(np.append([temp_sc26m_sens],[precip_sc26m_sens,vegDens_sens,lwr_sc26m_sens,swr_sc26m_sens_up]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc26m_up = randomForest_sensMod_predict(in_ut_0p_rf_sc26m,out_ut_0p_rf_sc26m,59,200,in_ut_0p_rf_sc26m_vegSen_up[5:87])

in_ut_0p_rf_sc26m_vegSen_low = pd.DataFrame(np.reshape(np.append([temp_sc26m_sens],[precip_sc26m_sens,vegDens_sens,lwr_sc26m_sens,swr_sc26m_sens_low]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc26m_low = randomForest_sensMod_predict(in_ut_0p_rf_sc26m,out_ut_0p_rf_sc26m,59,200,in_ut_0p_rf_sc26m_vegSen_low[5:87])
...
print (len(in_ut_0p_rf_sc17a[in_ut_0p_rf_sc17a['VegD']>0.90]))
...
in_ut_0p_rf_sc17a_vegSen_up = pd.DataFrame(np.reshape(np.append([temp_sc17a_sens],[precip_sc17a_sens,vegDens_sens,lwr_sc17a_sens,swr_sc17a_sens_up]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc17a_up = randomForest_sensMod_predict(in_ut_0p_rf_sc17a,out_ut_0p_rf_sc17a,59,200,in_ut_0p_rf_sc17a_vegSen_up[1:80])

in_ut_0p_rf_sc17a_vegSen_low = pd.DataFrame(np.reshape(np.append([temp_sc17a_sens],[precip_sc17a_sens,vegDens_sens,lwr_sc17a_sens,swr_sc17a_sens_low]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc17a_low = randomForest_sensMod_predict(in_ut_0p_rf_sc17a,out_ut_0p_rf_sc17a,59,200,in_ut_0p_rf_sc17a_vegSen_low[1:80])
...
in_ut_0p_rf_sc18m_vegSen_up = pd.DataFrame(np.reshape(np.append([temp_sc18m_sens],[precip_sc18m_sens,vegDens_sens,lwr_sc18m_sens,swr_sc18m_sens_up]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc18m_up = randomForest_sensMod_predict(in_ut_0p_rf_sc18m,out_ut_0p_rf_sc18m,59,200,in_ut_0p_rf_sc18m_vegSen_up[2:86])

in_ut_0p_rf_sc18m_vegSen_low = pd.DataFrame(np.reshape(np.append([temp_sc18m_sens],[precip_sc18m_sens,vegDens_sens,lwr_sc18m_sens,swr_sc18m_sens_low]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_sc18m_low = randomForest_sensMod_predict(in_ut_0p_rf_sc18m,out_ut_0p_rf_sc18m,59,200,in_ut_0p_rf_sc18m_vegSen_low[2:86])
...
#####random forest AI modeling for fSCA_0pen -- fsca_underTree  ##########################################
in_ut_0p_rf_jmz = in_out_rf_jmz_lswr_ls_drp_df[['temp','precip','VegD','lwr','swr']] #'nrth','elev','x','y', 0.065 random_state=50
...
numPix_m95Veg = len(in_ut_0p_rf_jmz[in_ut_0p_rf_jmz['VegD']>0.99])
...
in_ut_0p_rf_jmz_vegSen_up = pd.DataFrame(np.reshape(np.append([temp_jmz_sens],[precip_jmz_sens,vegDens_sens,lwr_jmz_sens,swr_jmz_sens_up]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_jmz_up = randomForest_sensMod_predict(in_ut_0p_rf_jmz,out_ut_0p_rf_jmz,59,200,in_ut_0p_rf_jmz_vegSen_up[3:92])

in_ut_0p_rf_jmz_vegSen_low = pd.DataFrame(np.reshape(np.append([temp_jmz_sens],[precip_jmz_sens,vegDens_sens,lwr_jmz_sens,swr_jmz_sens_low]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_jmz_low = randomForest_sensMod_predict(in_ut_0p_rf_jmz,out_ut_0p_rf_jmz,59,200,in_ut_0p_rf_jmz_vegSen_low[3:92])
...
print (len(in_ut_0p_rf_nrc0[in_ut_0p_rf_nrc0['VegD']>0.90]))
...
in_ut_0p_rf_nrc_vegSen_up = pd.DataFrame(np.reshape(np.append([temp_nrc_sens],[precip_nrc_sens,vegDens_sens,lwr_nrc_sens,swr_nrc_sens_up]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_nrc_up = randomForest_sensMod_predict(in_ut_0p_rf_nrc,out_ut_0p_rf_nrc,59,200,in_ut_0p_rf_nrc_vegSen_up[1:88])

in_ut_0p_rf_nrc_vegSen_low = pd.DataFrame(np.reshape(np.append([temp_nrc_sens],[precip_nrc_sens,vegDens_sens,lwr_nrc_sens,swr_nrc_sens_low]),(5,100)).T,columns = ['temp','precip','VegD','lwr','swr']).iloc[:,0:5]
sens_vegSwr_nrc_low = randomForest_sensMod_predict(in_ut_0p_rf_nrc,out_ut_0p_rf_nrc,59,200,in_ut_0p_rf_nrc_vegSen_low[1:88])
...
properties_rfm_nrc = [mean_abs_error_oput2_nrc, feature_importances_0p_ut_mean2_nrc, 'cornflowerblue', 'fSCAop-fSCAut for NRC']
properties_rfm_bins_nrc = [feature_importances_error_0putBin_nrc,importance_bins_nrc,color_nrc,'NRC']
properties_rfm_pred_nrc = [sens_vegSwr_nrc_up,sens_vegSwr_nrc_low,1,88,'blue','paleturquoise','NRC']
...
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_fusion_lidar/tempLsr_jfd_fsca_all_retile4.png')
...
label = ['Exposed','Sheltered','Exposed','Sheltered','Exposed','Sheltered',
...
label = ['Exposed-lowVD','Shelter-lowVD',
         'Exposed-highVD','Shelter-highVD',
         'Exposed-lowVD','Shelter-lowVD',
         'Exposed-highVD','Shelter-highVD',
         'Exposed-lowVD','Shelter-lowVD',
         'Exposed-highVD','Shelter-highVD',
         'Exposed-lowVD','Shelter-lowVD',
...
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_fusion_lidar/tempLsr_nrth_vegDens_all8_retile4.png')
