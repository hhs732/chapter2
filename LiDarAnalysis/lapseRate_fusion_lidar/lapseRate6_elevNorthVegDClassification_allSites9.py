...
def fsca0p_fscaUt_fscaLimit (fsca_0p_sc26m,fsca_0p_sc17a,fsca_0p_sc18m,fsca_0p_krew,fsca_0p_jmz,fsca_0p_nrc,
                             fsca_ut_sc26m,fsca_ut_sc17a,fsca_ut_sc18m,fsca_ut_krew,fsca_ut_jmz,fsca_ut_nrc,limitFsca):
    ...
    #%82 open- under
    limit = limitFsca
    fsca_0p_sc26m_lim = np.mean(fsca_0p_sc26m_arr[fsca_0p_sc26m_arr<limit])
    fsca_0p_sc17a_lim = np.mean(fsca_0p_sc17a_arr[fsca_0p_sc17a_arr<limit])
    fsca_0p_sc18m_lim = np.mean(fsca_0p_sc18m_arr[fsca_0p_sc18m_arr<limit])
    fsca_0p_krew_lim = np.mean(fsca_0p_krew_arr[fsca_0p_krew_arr<limit])
    fsca_0p_jmz_lim = np.mean(fsca_0p_jmz_arr[fsca_0p_jmz_arr<limit])
    fsca_0p_nrc_lim = np.mean(fsca_0p_nrc_arr[fsca_0p_nrc_arr<limit])

    fsca_ut_sc26m_lim = np.mean(fsca_ut_sc26m_arr[fsca_ut_sc26m_arr<limit])
    fsca_ut_sc17a_lim = np.mean(fsca_ut_sc17a_arr[fsca_ut_sc17a_arr<limit])
    fsca_ut_sc18m_lim = np.mean(fsca_ut_sc18m_arr[fsca_ut_sc18m_arr<limit])
    fsca_ut_krew_lim = np.mean(fsca_ut_krew_arr[fsca_ut_krew_arr<limit])
    fsca_ut_jmz_lim = np.mean(fsca_ut_jmz_arr[fsca_ut_jmz_arr<limit])
    fsca_ut_nrc_lim = np.mean(fsca_ut_nrc_arr[fsca_ut_nrc_arr<limit])
...
label0 = ['SCWC 26MAR2016-0p','SCWC 17APR2016-0p','SCWC 18MAY2016-0p','KREW 2010-0p','JRBN 2010-0p','NRC 2010-0p']
label1 = ['SCWC 26MAR2016-ut','SCWC 17APR2016-ut','SCWC 18MAY2016-ut','KREW 2010-ut','JRBN 2010-ut','NRC 2010-ut']
...
plt.xlabel('(fSCA_open_shl - fSCA_open_exp)', fontsize=80)
