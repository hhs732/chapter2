...
elevationBand_sc = np.arange(min(veg_snow_temp_sc_df['z']),max(veg_snow_temp_sc_df['z']),70)
veg_snow_temp_sc_clsf = classificationElevation(veg_snow_temp_sc,elevationBand_sc)

temp101_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==101)][:,7])
temp102_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==102)][:,7])
temp103_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==103)][:,7])
temp104_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==104)][:,7])
temp105_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==105)][:,7])
temp106_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==106)][:,7])
temp107_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==107)][:,7])
temp108_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==108)][:,7])
temp109_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==109)][:,7])
temp110_mean = np.mean(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,8]==110)][:,7])
...
#%% under canopy fsca
ascii_ut_snow101 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==101)])
ascii_ut_snow102 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==102)])
ascii_ut_snow103 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==103)])
ascii_ut_snow104 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==104)])
ascii_ut_snow105 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==105)])
ascii_ut_snow106 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==106)])
ascii_ut_snow107 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==107)])
ascii_ut_snow108 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==108)])
ascii_ut_snow109 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==109)])
ascii_ut_snow110 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==77)&(veg_snow_temp_sc_clsf[:,8]==110)])

ascii_ut_nsnow101 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==101)])
ascii_ut_nsnow102 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==102)])
ascii_ut_nsnow103 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==103)])
ascii_ut_nsnow104 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==104)])
ascii_ut_nsnow105 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==105)])
ascii_ut_nsnow106 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==106)])
ascii_ut_nsnow107 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==107)])
ascii_ut_nsnow108 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==108)])
ascii_ut_nsnow109 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==109)])
ascii_ut_nsnow110 = len(veg_snow_temp_sc_clsf[(veg_snow_temp_sc_clsf[:,5]==-7)&(veg_snow_temp_sc_clsf[:,8]==110)])
