...
lat_sc_deg = tempMin2016.variables['lat'][343:346] #
long_sc_deg = tempMin2016.variables['lon'][106:110] # 
...
lat_flip_sc = lat_flip [343:346]
long_flip_sc = elevation_gridMet.variables['lon'] [106:110]

elevation_gridMet_flip = np.flip(elevation_gridMet.variables['elevation'][:], axis = 0)
elevation_gridMet_sc = elevation_gridMet_flip[343:346, 106:110]
elevation_sc_ls = [2396.2,2194.8,2116,1963.3,2386.6,2228.7,2098.8,1985.3,2454.8,2244.2,2091.2,1973.2]

#%% temperature
#tempMin = tempMin2016.variables['air_temperature'][:]
tempMin_sc15d = tempMin2015.variables['air_temperature'][335:366, 343:346, 106:110]-273.15
tempMin_sc16j = tempMin2016.variables['air_temperature'][0:31, 343:346, 106:110]-273.15
tempMin_sc16f = tempMin2016.variables['air_temperature'][31:60, 343:346, 106:110]-273.15

tempMax_sc15d = tempMax2015.variables['air_temperature'][335:366, 343:346, 106:110]-273.15
tempMax_sc16j = tempMax2016.variables['air_temperature'][0:31, 343:346, 106:110]-273.15
tempMax_sc16f = tempMax2016.variables['air_temperature'][31:60, 343:346, 106:110]-273.15
...
meanTemp_djf_ls = [-0.675827,-0.219729,-0.184241,-0.314239,-1.09256,-0.725272,-0.482033,-0.790013,-1.45112,-0.729759,-0.80674	,-1.1651]
...
lat_long_nad83_krew = [np.min(ascii_grid_veg_index26m[:,0]),np.max(ascii_grid_veg_index26m[:,0]),np.min(ascii_grid_veg_index26m[:,1]),np.max(ascii_grid_veg_index26m[:,1])]
lat_long_degre_krew = [39.403596, 39.464694, -120.31719287846941, -120.23349053231303]
...
tempDJF_sc17a = p_sc(ascii_grid_veg_index_ls17a[:,2])
...
veg_snow_temp_sc_clsf17a = classificationElevation(veg_snow_temp_sc17a,elevationBand_sc)

# under canopy and 0pen fsca
fSCA_ut_sc17a, fSCA_0p_sc17a = fSCAcalculation_elevClassific(veg_snow_temp_sc_clsf17a)

#fsca open -minus- fsca under canopy
fSCA_0u_sc17a = fsca0pn_fscaUnTr(fSCA_ut_sc17a,fSCA_0p_sc17a)
...
tempDJF_sc24m = p_sc(ascii_grid_veg_index_ls24m[:,2])
...
ax.scatter(meanTemp_elevClass_sc,fSCA_0u_sc17a, label = 'Sagehen Creek 17April2016', s=20**2, color = 'green')#r2=%.6f'%(r_value_tempFsca26M**2)
ax.scatter(meanTemp_elevClass_sc,fSCA_0u_sc24m, label = 'Sagehen Creek 24May2016', s=20**2, color = 'orange')#r2=%.6f'%(r_value_tempFsca26M**2)

plt.plot(meanTemp_elevClass_sc,fSCA_0u_sc26m, color = 'blue')
plt.plot(meanTemp_elevClass_sc,fSCA_0u_sc17a, color = 'green')
plt.plot(meanTemp_elevClass_sc,fSCA_0u_sc24m, color = 'orange')
...
# the line equation:
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/tempLsr_sc2.png')
