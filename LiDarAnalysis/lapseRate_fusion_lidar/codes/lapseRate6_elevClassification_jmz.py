...
lat_Jmz_deg = tempMin2010.variables['lat'][259:262] #0.02083333333333215
long_Jmz_deg = tempMin2010.variables['lon'][435:439] #0.02083333333333215
...
lat_flip_local = lat_flip [259:262]
long_flip_local = elevation_gridMet.variables['lon'] [435:439]

elevation_gridMet_flip = np.flip(elevation_gridMet.variables['elevation'][:], axis = 0)
elevation_gridMet_local = elevation_gridMet_flip[259:262, 435:439]
elevation_ls = [2445.6,2591,3003.5,2723.1,2536.9,2712.9,2902.6,2816.1,2663.8,2748.1,2738.2,2715.2]

#%% temperature
#tempMin = tempMin2010.variables['air_temperature'][:]
tempMin_09d = tempMin2009.variables['air_temperature'][335:366, 259:262, 435:439]-273.15
tempMin_10j = tempMin2010.variables['air_temperature'][0:31, 259:262, 435:439]-273.15
tempMin_10f = tempMin2010.variables['air_temperature'][31:59, 259:262, 435:439]-273.15

tempMax_09d = tempMax2009.variables['air_temperature'][335:366, 259:262, 435:439]-273.15
tempMax_10j = tempMax2010.variables['air_temperature'][0:31, 259:262, 435:439]-273.15
tempMax_10f = tempMax2010.variables['air_temperature'][31:59, 259:262, 435:439]-273.15
...
meanTemp_djf_ls = [-2.82418,-2.56776,-3.77947,-4.07173,-3.37084,-3.51014,-4.08541,-4.63737,-4.24087,-4.4199,-4.94168,-5.42855]
...
tempDJF_gm = p_sc(ascii_grid_veg_index_lsJmz[:,2])
...
veg_snow_temp_clsfJmz = classificationElevation(veg_snow_temp_Jmz,elevationBand)

meanTemp_elevClass = calculationMeanTempforEachElevClassification(veg_snow_temp_clsfJmz)   
# under canopy and 0pen fsca
fSCA_ut_Jmz, fSCA_0p_Jmz = fSCAcalculation_elevClassific(veg_snow_temp_clsfJmz)

#fsca open -minus- fsca under canopy
fSCA_0u_Jmz = fsca0pn_fscaUnTr(fSCA_ut_Jmz,fSCA_0p_Jmz)

#%% ploting DJF temp
fig, ax = plt.subplots(figsize=(20,15))
ax.scatter(meanTemp_elevClass,fSCA_0u_Jmz, label = 'Jemez 2010', s=20**2, color = 'blue')#r2=%.6f'%(r_value_tempFscaJmz**2)
plt.plot(meanTemp_elevClass,fSCA_0u_Jmz, color = 'blue')
...
# the line equation:
plt.savefig('C:/1UNRuniversityFolder/Dissertation/Chapter 2-snow-forest/LiDarAnalysis/lapseRate_gridMet/tempLsr_Jmz.png')
