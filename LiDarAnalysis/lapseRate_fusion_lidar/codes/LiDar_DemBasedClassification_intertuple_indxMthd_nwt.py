...
filenameS0fvcm = "F:/hhs/lidar_analysis/niwot/snw0ff_nwt_dem.tif"
...
elevNrth_gp_vcm, index_vcm = calculatingSlopeAspectNorthness(filenameS0fvcm,'F:/hhs/lidar_analysis/niwot/slopeNwt.tif',
                                                             'F:/hhs/lidar_analysis/niwot/aspectNwt.tif',elevationVegvcm,
                                                             nrows_vcm,ncols_vcm,lat_vcm,long_vcm)

#las file snow off (snw) for vcm
lasFilePath_vegVcm1 = "F:/hhs/lidar_analysis/niwot/snw0ff_nwt_points1.las"
lasFilePath_vegVcm2 = "F:/hhs/lidar_analysis/niwot/snw0ff_nwt_points2.las"

coordsVegVcm_df1 = readLasFile (lasFilePath_vegVcm1)
coordsVegVcm_df2 = readLasFile (lasFilePath_vegVcm2)
coordsVegVcm_df = pd.concat([coordsVegVcm_df1,coordsVegVcm_df2])
coordsVegVcm_df.sort_values(by=['x','y'],inplace=True)

#validation las file for snow 0n and snow off (road map)
#lasFilePath_road0n = "F:/hhs/lidar_analysis/niwot/nwt_road_snw0n.las"
#coordsrson_df1 = readLasFile (lasFilePath_road0n)
#
#lasFilePath_road0f = "F:/hhs/lidar_analysis/niwot/nwt_road_snw0ff.las"
#coordsrsof_df1 = readLasFile (lasFilePath_road0f)

coordsVegVcm_df['z'] = coordsVegVcm_df['z']-0.03

#las file snow on (snw) for vcm
lasFilePath_snwVcm1 = "F:/hhs/lidar_analysis/niwot/snw0n_nwt_points5.las"
lasFilePath_snwVcm2 = "F:/hhs/lidar_analysis/niwot/snw0n_nwt_points9.las"
lasFilePath_snwVcm3 = "F:/hhs/lidar_analysis/niwot/snw0n_nwt_points20.las"

coordsSnwVcm_df1 = readLasFile (lasFilePath_snwVcm1)
coordsSnwVcm_df2 = readLasFile (lasFilePath_snwVcm2)
coordsSnwVcm_df3 = readLasFile (lasFilePath_snwVcm3)
coordsSnwVcm_df = pd.concat([coordsSnwVcm_df1,coordsSnwVcm_df2,coordsSnwVcm_df3])
...
upGroundPointsVegVcm_df = pd.DataFrame(upGroundPointsVegVcm).astype(int)
np.min(upGroundPointsVegVcm_df[2])
...
path2npoutVeg="F:/hhs/lidar_analysis/niwot/upGroundPointsVegNwt.npy"
np.save(path2npoutVeg,upGroundPointsVegVcm)   
upLoadUpGroundPointsVeg=np.load(path2npoutVeg)

path2npoutSnw="F:/hhs/lidar_analysis/niwot/upGroundPointsSnwNwt.npy"
np.save(path2npoutSnw,upGroundPointsSnwVegVcm)   
upLoadUpGroundPointsSnw=np.load(path2npoutSnw)

#dem_groundPointsVegVcm_intg_test = dem_groundPointsVegVcm_intg[['x','y','z']][0:20000].astype(int)
#coordsVegVcm_intg_test = coordsVegVcm_intg[['x','y','z']][0:200000].astype(int)
#vegClassVcm_df_test = pd.concat([vegClassVcm_df[['x','y']][0:200000].astype(int),vegClassVcm_df['z'][0:200000]], axis = 1)
...
#path3npoutSnw="F:/hhs/lidar_analysis/niwot/allTreeClassNwt.npy"
...
#path4npoutSnw="F:/hhs/lidar_analysis/niwot/allTreeClassNoLowVegNwt.npy"
...
#path5npoutSnw="F:/hhs/lidar_analysis/niwot/all0penClassNoGrassNwt.npy"
...
#path6npoutSnw="F:/hhs/lidar_analysis/niwot/allSnowNoLowVegClassNwt.npy"
...
#path7npoutSnw="F:/hhs/lidar_analysis/niwot/allsnowUnderTreeClassNwt.npy"
...
allNoSnowUnderTreeClassVcm_df = pd.DataFrame(defineSpecificClassGreater (allNoSnowUnderTreeClassVcm_df0[['x','y','z']], -0.15))
allNoSnowUnderTreeClassVcm_df.index = allNoSnowUnderTreeClassVcm_df['Index']
#path8npoutSnw="F:/hhs/lidar_analysis/niwot/allNoSnowUnderTreeClassNwt.npy"
...
#path9npoutSnw="F:/hhs/lidar_analysis/niwot/allSnow0penGroundClassNwt.npy"
...
allNoSnow0penClassVcm = pd.DataFrame(defineSpecificClassGreater (allNoSnow0penClassVcm0[['x','y','z']], -0.15))
allNoSnow0penClassVcm.index = allNoSnow0penClassVcm['Index']
#path10npoutSnw="F:/hhs/lidar_analysis/niwot/allNoSnow0penClassNwt.npy"
...
plt.savefig('F:/hhs/lidar_analysis/fSCA_pixel_JemezVCM_elev_topo15_3.png')
