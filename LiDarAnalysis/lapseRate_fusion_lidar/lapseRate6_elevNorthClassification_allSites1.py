...
def fSCAcalculation_elevNorthRandom(veg_snow_temp_elev_clsf_file,elev_class_inx): #veg_snow_temp_elev_clsf_file[:,8]==101 contains elevation classification
    
    randomNum = np.random.randint(0,100,size=len(veg_snow_temp_elev_clsf_file[:,0]))
    ...
    for indx in range (len(elev_class_inx)): 
        ...
        for rand in range (100):
            ...
            fSCA_unTr_exp_rand.append(fSCA_ut_exp)
            fSCA_unTr_shl_rand.append(fSCA_ut_shl)
            ...
            fSCA_0pen_exp_rand.append(fSCA_0p_exp)
            fSCA_0pen_shl_rand.append(fSCA_0p_shl)
    
        fSCA_unTr_exp.append(fSCA_unTr_exp_rand)
        fSCA_unTr_shl.append(fSCA_unTr_shl_rand)
        fSCA_0pen_exp.append(fSCA_0pen_exp_rand)
        fSCA_0pen_shl.append(fSCA_0pen_shl_rand)
...
fSCA_ut_exp_nrc100, fSCA_ut_shl_nrc100, fSCA_0p_exp_nrc100, fSCA_0p_shl_nrc100 = fSCAcalculation_elevNorthRandom(veg_snow_temp_clsfnrc,elev_class_inx)
