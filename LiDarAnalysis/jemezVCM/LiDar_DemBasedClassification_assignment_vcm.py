...
dem_groundPointsVegVcm_ls_bnry = np.vstack([dem_groundPointsVegVcm_df['x']-np.min(dem_groundPointsVegVcm_df['x']),
                                                 dem_groundPointsVegVcm_df['y']-np.min(dem_groundPointsVegVcm_df['y']),
                                                 dem_groundPointsVegVcm_df['z']]).T
...
dem_groundPointsVegVcm_intg_ls_bnry = np.vstack([dem_groundPointsVegVcm_intg['x']-np.min(dem_groundPointsVegVcm_intg['x']),
                                                 dem_groundPointsVegVcm_intg['y']-np.min(dem_groundPointsVegVcm_intg['y']),
                                                 dem_groundPointsVegVcm_intg['z']]).T
