...
topo_dimension_vcm = classificationNorthnessElev(indexVcm_cut.values,2830,3140,201,minXVcm,minYVcm)

#%% classification with grountpoints from veg dem file :VCM
upGroundPointsVegVcm = calculatingUpGroundPoints (coordsVegVcm_intg,dem_groundPointsVegVcm_intg,201)
#classification of snow las file with veg_grountpoints
upGroundPointsSnwVegVcm = calculatingUpGroundPoints (coordsSnwVcm_intg,dem_groundPointsVegVcm_intg,201)
...
vegClassVcm_indx, vegClassVcm_df = createClassIndexBasedDF(vegClassVcm,201)
...
snowClassVcm_indx, snowClassVcm_df = createClassIndexBasedDF(snowClassVcm,201)
