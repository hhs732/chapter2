...
minXVcm = np.min(coordsVegVcm_df['x'])
maxXVcm = np.max(dem_groundPointsVegVcm_df['x'])
minYVcm = np.min(coordsVegVcm_df['y'])
maxYVcm = np.max(dem_groundPointsVegVcm_df['y'])
...
#%% box plot
d1 = [Open_el_vcm_df[:,2],UnTree_el_vcm_df[:,2],Open_nl_vcm_df[:,2],UnTree_nl_vcm_df[:,2],
      Open_sl_vcm_df[:,2],UnTree_sl_vcm_df[:,2],Open_em_vcm_df[:,2],UnTree_em_vcm_df[:,2],
      Open_nm_vcm_df[:,2],UnTree_nm_vcm_df[:,2],Open_sm_vcm_df[:,2],UnTree_sm_vcm_df[:,2],
      Open_eh_vcm_df[:,2],UnTree_eh_vcm_df[:,2],Open_nh_vcm_df[:,2],UnTree_nh_vcm_df[:,2],
      Open_sh_vcm_df[:,2],UnTree_sh_vcm_df[:,2]]
