...
filenameS0fvcm = "G:/hhs/lidar_analysis/sagehen/dem2014snow0ff.tif"
elevationVegvcm = readPlotDEM(filenameS0fvcm,elevationMissNoS0f)#,pathNameS0fvcm

filename_slope = "G:/hhs/lidar_analysis/sagehen/slopeSc.tif"
...
elevNrth_gp_vcm, index_vcm = calculatingSlopeAspectNorthness(filenameS0fvcm,'G:/hhs/lidar_analysis/sagehen/slopeSc.tif',
                                                             'G:/hhs/lidar_analysis/sagehen/aspectSc.tif',elevationVegvcm,
                                                              nrows_vcm,ncols_vcm,lat_vcm,long_vcm)
index_vcm[:,4][(index_vcm[:,4]==-9999.)]=31
index_noG30 = index_vcm[(index_vcm[:,4]<30.1)] #slope less than 30

#las file snow off (snw) for vcm
lasFilePath_vegVcm1 = "G:/hhs/lidar_analysis/sagehen/snw0ff_sc_points.las"
...
coordsSnwVcm_df = coordsnow0nSc26M.copy()
coordsSnwVcm_df['z'] = coordsSnwVcm_df['z']-0.23
...
path2npoutVeg="G:/hhs/lidar_analysis/sagehen/upGroundPointsVegSc.npy"
np.save(path2npoutVeg,upGroundPointsVegVcm)   
upLoadUpGroundPointsVeg=np.load(path2npoutVeg)

path2npoutSnw="G:/hhs/lidar_analysis/sagehen/upGroundPointsSnwSc.npy"
...
path3npoutSnw="G:/hhs/lidar_analysis/sagehen/allTreeClassSc.npy"
...
path4npoutSnw="G:/hhs/lidar_analysis/sagehen/allTreeClassNoLowVegSc.npy"
...
path5npoutSnw="G:/hhs/lidar_analysis/sagehen/all0penClassNoGrassSc.npy"
...
path6npoutSnw="G:/hhs/lidar_analysis/sagehen/allSnowNoLowVegClassSc.npy"
...
path7npoutSnw="G:/hhs/lidar_analysis/sagehen/allsnowUnderTreeClassSc.npy"
...
path8npoutSnw="G:/hhs/lidar_analysis/sagehen/allNoSnowUnderTreeClassSc.npy"
...
path9npoutSnw="G:/hhs/lidar_analysis/sagehen/allSnow0penGroundClassSc.npy"
...
path10npoutSnw="G:/hhs/lidar_analysis/sagehen/allNoSnow0penClassSc.npy"
...
rects1 = plt.bar(index, d11, bar_width,color='wheat',edgecolor='tan',label='0pen')
...
plt.savefig('G:/hhs/lidar_analysis/sagehen/fSCA_pixel_sagehen_elev_topo15_noG30M26.png')
