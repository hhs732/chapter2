...
#%% dem snow off (veg) 
elevationMissNoS0f = 2200.
#G:/hhs_DST/lidar_analysis/fusion/
extent2 = [450000,455100,4425500,4430700]

filenameIn = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffBoulder.tif"
pathNameOut = "G:/hhs_DST/lidar_analysis/fusion/demSnw0ffBoulder.png"
...
elevNrth_gp, index_df = calculatingSlopeAspectNorthness(filenameIn,-1.1,
                                                        'G:/hhs_DST/lidar_analysis/fusion/slopeBol.tif',
                                                        'G:/hhs_DST/lidar_analysis/fusion/aspectBol.tif')
...
veg_count_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_count.asc"
veg_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_count.png"
...
veg_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_totalCount.asc"
veg_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_totalCount.png"
...
veg_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_allCoverCount.asc"
veg_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_veg_allCoverCount.png"
...
veg_density_bl = veg_allCoverCount_df_cut['z']/veg_totalCount_df_cut['z']
veg_density_bl_ls = np.vstack([veg_allCoverCount_df_cut['x'],veg_allCoverCount_df_cut['y'],veg_density_bl]).T
np.save('G:/hhs_DST/lidar_analysis/fusion/veg_density_bl', veg_density_bl_ls)
#%% ascii files snow 0n 23May2016
#loading snow ascii file (count)
snow_count_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_count.asc"
snow_count_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_count.png"
...
snow_totalCount_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_totalCount.asc"
snow_totalCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_totalCount.png"
...
snow_allCoverCount_path = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_allCoverCount.asc"
snow_allCoverCount_path_out = "G:/hhs_DST/lidar_analysis/fusion/boulder_allcount/boulder_snw_allCoverCount.png"
...
np.save('G:/hhs_DST/lidar_analysis/fusion/ascii_index_pr_nrc', ascii_index_pr)

#calculating topo_dimension from cut northness
properties = [-0.1,0.1,2820,3050] #2570 3290
...
rects1 = plt.bar(index, d11, bar_width, color='snow', edgecolor='brown', label='0pen') #  snow  ghostwhite

rects2 = plt.bar(index + bar_width, d22, bar_width, color='green',label='underTree')#   green  olivedrab edgecolor='darkgreen', 
...
plt.title('fSCA% in NRC in May2010', fontsize=40)
plt.legend(fontsize=30, loc = 'upper left')

plt.savefig('G:/hhs_DST/lidar_analysis/fusion/fSCA_pixel_boulder_elev_topo10_noG30.png')
